		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#sapbtphelloworldui5clon-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtphelloworldui5clon-display": {
								"semanticObject": "sapbtphelloworldui5clon",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.helloworldui5clon",
									"url": sap.ui.require.toUrl("sap/btp/helloworldui5clon")
								}
							}
						}
					}
